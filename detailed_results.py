...
"""
スケジュール最適化の詳細プロセスと結果をファイルに保存するスクリプト
"""
...
def main():
    ...
    # 結果ファイルのパス
    results_file = os.path.join(results_dir, "detailed_schedule_results.txt")
    
    # 結果をファイルに書き込む
    with open(results_file, 'w', encoding='utf-8') as f:
        f.write("=================================================\n")
        f.write("スケジュール最適化の詳細プロセスと結果\n")
        f.write("=================================================\n\n")
        ...
        f.write("このスケジュール最適化では、21名の生徒を3つの曜日（火曜日、水曜日、木曜日）に\n")
        f.write("7名ずつ割り当てました。各生徒の希望を最大限考慮し、できるだけ多くの生徒が\n")
